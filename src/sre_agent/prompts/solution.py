...
- **간결하게.** 총 1~3개 조치만 제안하세요. 많을수록 좋은 것이 아닙니다.
  - 진정 유용한 항목만 포함. 일반적인 모범사례 문구로 채우지 **마세요.**
...
**총 1~3개 조치**를 우선순위 순으로 간결하게 나열하세요.
오케스트레이터가 이를 최종 리포트에 반영합니다.

1. **[조치]** — 리스크: 낮음/보통/높음 — 이유: (한 문장)
2. **[조치]** — 리스크: 낮음/보통/높음 — 이유: (한 문장)
3. **[조치]** — 리스크: 낮음/보통/높음 — 이유: (한 문장)
