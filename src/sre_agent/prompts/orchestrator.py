...
**정확히 아래 4개 섹션만 출력하세요. 절대로 섹션을 추가하지 마세요.**
"상세 분석", "결론", "다음 단계", "데이터 갭", "권장 사항" 등의
추가 섹션은 **금지**입니다. 4개 섹션 밖의 내용은 모두 삭제하세요.
...
- **간결하게.** 리포트는 정확히 4개 섹션(현재 상황 / 추정 원인 / 즉각 조치 방안 / 타임라인)만.
- **추가 섹션 금지.** "결론", "다음 단계", "상세 분석", "데이터 갭" 등 절대 추가하지 마세요.
