...
def seed():
    ...
    servers = [
        {
            "hostname": "web-prod-kr-042",
            "ip_addresses": ["10.0.3.42"],
            "os": "ubuntu-22.04",
            "kernel": "5.15.0-91",
            "environment": "production",
            "platform": "aws/ec2",
            "team_owner": "platform-sre",
            "owner_contact": "김SRE",
            "service_description": "결제 API 프론트 프록시",
            "business_impact": "critical",
            "caution_notes": [
                "nginx reload 시 30초 grace period 필요",
                "매월 1일 정산 배치 — PM 금지",
            ],
        ...
        {
            "hostname": "api-prod-kr-010",
            "ip_addresses": ["10.0.3.100"],
            "os": "ubuntu-22.04",
            "kernel": "5.15.0-91",
            "environment": "production",
            "platform": "aws/ec2",
            "team_owner": "backend-sre",
            "owner_contact": "이SRE",
            "service_description": "결제 Spring Boot API",
            "business_impact": "critical",
            "caution_notes": ["JVM heap 8GB — 줄이지 말 것"],
            "maintenance_window": "화/목 02:00-06:00",
        },
        {
            "hostname": "db-prod-kr-001",
            "ip_addresses": ["10.0.3.200"],
            "os": "ubuntu-22.04",
            "environment": "production",
            "platform": "bare-metal",
            "team_owner": "dba-sre",
            "owner_contact": "박DBA",
            "service_description": "결제 PostgreSQL primary",
            "business_impact": "critical",
            "caution_notes": ["replication lag 확인 필수", "PM 시 replica promote 먼저"],
            "maintenance_window": "일 03:00-05:00",
        },
        {
            "hostname": "web-stg-kr-001",
